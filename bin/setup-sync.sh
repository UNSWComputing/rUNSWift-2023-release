...
if ! ssh-keygen -l -f ~/.ssh/id_ed25519 &> /dev/null || ssh-keygen -l -f ~/.ssh/id_ed25519.pub &> /dev/null; then
  ssh-keygen -l -f ~/.ssh/id_ed25519.pub &> /dev/null || ssh-keygen -f ~/.ssh/id_ed25519 -N '' -q
...
elif ! ssh-keygen -l -f ~/.ssh/id_rsa &> /dev/null || ssh-keygen -l -f ~/.ssh/id_rsa.pub &> /dev/null; then
