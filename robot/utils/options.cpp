...
po::options_description store_and_notify(vector<string> argv,
   ...
   /** Config hierarchy (earlier overrides latter):
    *  - first,  command line arguments
    *  - second, /home/nao/data/configs/$hostname.cfg
    *  - third,  /home/nao/data/simswift.cfg           (if simulation)
    *  - fourth, /home/nao/data/configs/body/$body.cfg (for body-specific configs, may be different to head as specified in [player] bodyName)
