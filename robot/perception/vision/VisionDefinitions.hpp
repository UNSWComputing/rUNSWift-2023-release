...
// This is the amount of space reserved on blackboard for regions. If more space
// is needed it will be allocated dynamically.
#define ESTIMATED_REGIONS 300

#ifdef CTC_2_1
//http://doc.aldebaran.com/2-1/family/robots/video_robot.html#location
   #define IMAGE_HFOV DEG2RAD(60.97) // horizontal field of view
   #define IMAGE_VFOV DEG2RAD(47.64)
#else
//http://doc.aldebaran.com/2-8/family/nao_technical/video_naov6.html#specifications
   #define IMAGE_HFOV DEG2RAD(56.3) // horizontal field of view
   #define IMAGE_VFOV DEG2RAD(43.7)
#endif

// NOTE: NONE OF THE BELOW HAVE BEEN CHECKED IF THEY'RE ACTUALLY USED
...
typedef Colour TopSaliency[TOP_SALIENCY_COLS][TOP_SALIENCY_ROWS];
typedef Colour BotSaliency[BOT_SALIENCY_COLS][BOT_SALIENCY_ROWS];
 ...
 **/
#define MIN_GREEN_THRESHOLD (100 * BOT_IMAGE_COLS / 640 / BOT_SALIENCY_DENSITY)
...
/**
 * The default window size and percentage to be used in function defs
 **/
#define DEFAULT_ADAPTIVE_THRESHOLDING_WINDOW_SIZE 51
#define DEFAULT_ADAPTIVE_THRESHOLDING_WHITE_THRESHOLD_PERCENT -20

/**
 * An undefined adaptive thresholding value that neither a window size
