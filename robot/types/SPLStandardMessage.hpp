...
/*
 * SPL Rules in 2023 limit us to a 128 B payload.
 * We have to subtract the prefix to the data - 34 bytes.
 * So we have in the end 128 - 34 = 94 bytes free payload.
 */
#define SPL_STANDARD_MESSAGE_DATA_SIZE      94
