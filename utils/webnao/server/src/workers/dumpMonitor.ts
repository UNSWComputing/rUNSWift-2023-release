...
export class DumpMonitor {
  ...
  constructor(protected dumpFolderPath: string, protected scanSeconds: number = 10) {
    this._dumpState = [];
  ...
  protected indexDump(dumpPath: string): Promise<DumpIndex> {
