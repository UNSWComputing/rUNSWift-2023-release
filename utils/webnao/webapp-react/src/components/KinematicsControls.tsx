...
export default function KinematicsControls() {
  ...
  const kinematicsSettings: Kinematics_Parameters = {
        ...
        <Stack direction="column">
          ...
          <Stack spacing={2} direction='row'>
            <Slider 
              ...
              max={5}
              step={0.2}
              onChange={onCameraPitchTopChange}></Slider>
          </Stack>
        </Stack>
        <Stack direction="column">
          ...
          <Stack spacing={2} direction='row'>
            <Slider 
              ...
              max={5}
              step={0.2}
              onChange={onCameraYawTopChange}></Slider>
          </Stack>
        </Stack>
        <Stack direction="column">
          ...
          <Stack spacing={2} direction='row'>
            <Slider 
              ...
              max={5}
              step={0.2}
              onChange={onCameraRollTopChange}></Slider>
          </Stack>
        </Stack>
        <Stack direction="column">
          ...
          <Stack spacing={2} direction='row'>
            <Slider 
              ...
              max={5}
              step={0.2}
              onChange={onCameraYawBottomChange}></Slider>
          </Stack>
        </Stack>
        <Stack direction="column">
          ...
          <Stack spacing={2} direction='row'>
            <Slider 
              ...
              max={5}
              step={0.2}
              onChange={onCameraPitchBottomChange}></Slider>
          </Stack>
        </Stack>
        <Stack direction="column">
          ...
          <Stack spacing={2} direction='row'>
            <Slider 
              ...
              max={5}
              step={0.2}
              onChange={onCameraRollBottomChange}></Slider>
          </Stack>
        </Stack>
        <Stack direction="column">
          BodyPitch: {bodyPitch}
          <Stack spacing={2} direction='row'>
            <Slider 
              ...
              max={5}
              step={0.2}
              onChange={onBodyPitchChange}></Slider>
          </Stack>
        </Stack>
      </Stack>
    </React.Fragment>
