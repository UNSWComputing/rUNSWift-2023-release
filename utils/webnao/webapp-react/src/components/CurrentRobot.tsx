    ...
    <React.Fragment>
        <ListItem>
          ...
          <Box sx={{display: 'flex', flexDirection: 'row', alignItems: 'center'}}>
            <div>{currentRobot?.robotInfo.name} T{currentRobot?.robotInfo.blackboardSnapshot?.gameController?.ourTeam?.teamNumber}P{currentRobot?.robotInfo.blackboardSnapshot?.gameController?.playerNumber} </div>
          ...
          </Box> : <ListItemText>Disconnected</ListItemText>
          } 
        </ListItem>
    </React.Fragment>
  );
